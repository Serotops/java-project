...
public class ZooMain 
{
	...
	public static void main(String[] args) 
	{
		...
		Bear Ours2 = new Bear("Baloo", "Male", 150, 230, 12);
		
		Eagle Aigle1 = new Eagle("Quinn", "Femelle", 15, 80, 9);
		Eagle Aigle2 = new Eagle("D-eagle", "Femelle", 15, 80, 9);
		
		Wolf Loup1 = new Wolf("Loupé", "Male", 35, 90, 11);
		Wolf Loup2 = new Wolf("Garou", "Male", 35, 90, 11);
		
		Tiger Tigre1 = new Tiger("Sherkan", "Male", 120, 100, 24);
		Tiger Tigre2 = new Tiger("Tigrou", "Male", 120, 100, 24);
		
		Whale Baleine1 = new Whale("MobyDick", "Femelle", 400, 130, 2);
		Whale Baleine2 = new Whale("BobyDick", "Femelle", 400, 130, 2);
		
		RedFish Poisson1 = new RedFish("Strasky", "Femelle", 0.214, 8, 5);
		RedFish Poisson2 = new RedFish("Hutch", "Femelle", 0.214, 8, 5);
		
		Shark Requin1 = new Shark("Don Lino", "Male", 300, 220, 17);
		Shark Requin2 = new Shark("Nado", "Male", 300, 220, 17);
		
		Penguin Ping1 = new Penguin("Pain", "Male", 40, 70, 34);
		Penguin Ping2 = new Penguin("Gouin", "Male", 40, 70, 34);
		...
		System.out.println(Ours1.beFed());
	}
